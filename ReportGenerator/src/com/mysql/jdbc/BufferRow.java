...
/* 509 */       sqlEx = SQLError.createSQLException("", this.exceptionInterceptor);
/*     */ 
...
/*     */     {
/* 685 */       this.isNull[i] = ((nullBitMask[nullMaskPos] & bit) != 0 ? 1 : false);
/*     */ 
/* 687 */       if ((bit <<= 1 & 0xFF) == 0) {
/* 688 */         bit = 1;
/*     */ 
