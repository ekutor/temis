  ...
  implements PdfViewerPreferences, PdfEncryptionSettings
{
  ...
  public PdfCopyForms(OutputStream paramOutputStream)
    throws DocumentException
  {
    this.fc = new PdfCopyFormsImp(paramOutputStream);
  }
  ...
  public void copyDocumentFields(PdfReader paramPdfReader)
    throws DocumentException
  {
    this.fc.copyDocumentFields(paramPdfReader);
  }
 ...
 * Qualified Name:     com.lowagie.text.pdf.PdfCopyForms
