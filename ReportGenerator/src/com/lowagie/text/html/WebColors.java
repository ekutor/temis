...
public class WebColors extends HashMap
{
  ...
  public static Color getRGBColor(String paramString)
    throws IllegalArgumentException
  {
    ...
    {
      StringTokenizer localStringTokenizer = new StringTokenizer(paramString, "rgb(), \t\r\n\f");
      for (int i = 0; i < 3; i++)
      {
 ...
 * Qualified Name:     com.lowagie.text.html.WebColors
